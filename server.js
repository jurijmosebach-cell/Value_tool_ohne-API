...
// League IDs according to Football-Data.org
const LEAGUE_IDS = {
  "Premier League": "PL",
  "Bundesliga": "BL1",
  "Eredivisie": "DED",
  ...
  "Championship": "ELC",
  "Primeira Liga": "PPL",
  "European Championship": "EG",
  "Serie A": "SA",
  "UEFA Champions League": "CL",
  "FIFA-Weltmeisterschaft": "WC"
};
...
async function fetchGamesFromAPI(){
  ...
  for(const [leagueName, id] of Object.entries(LEAGUE_IDS)){
    try {
      const url = `https://api.football-data.org/v4/competitions/${id}/matches?status=SCHEDULED,LIVE`;
